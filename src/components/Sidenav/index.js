...
class Sidebar extends React.Component {
  ...
  render() {
    ...
    let toggleIcon = null;
    if (navCollapsed) {
      toggleIcon = <i className="material-icons">keyboard_arrow_left</i>;
    } else {
      toggleIcon = <i className="material-icons">keyboard_arrow_right</i>;
    }
    ...
    return (
      <nav
        ...
        <section
          ...
          <img src="../../assets/react.svg" alt="" className="logo-img" />
        </section>
